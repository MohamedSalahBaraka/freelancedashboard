...
const ViewSubscription = () => {
    ...
    const fetchData = () => {
        ...
        const url = process.env.REACT_APP_MAIN_URL + "/dashboard/Subscription";
        axios
            .get(url, config)
            .then((response) => {
    ...
    const renderSubscriptions = Subscriptions && Subscriptions.map((Subscription, index) => {
        return (
            <tr key={index}>
                <th>{index + 1}</th>
                <th>
                    <div className="dropdown">
                        ...
                        <div className="dropdown-menu dropdown-menu-start"
                            ...
                            <Link className='dropdown-item text-end' to={`/ShowSubscriptions/${Subscription.id}`}>
                            ...
                            <DeleteButton fetchData={fetchData} id={Subscription.id} name={Subscription.name} url='Subscription' key={index} />
                        </div>
                    </div>
                </th>
        ...
        <div className="container d-flex flex-column flex-grow-1 flex-wrap justify-content-center align-items-center">
            <div className="container pt-3">
                <div className="row justify-content-center">
                    <label htmlFor="floatingInput " className="h1">جميع الاشتراكات</label>
